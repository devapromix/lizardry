...
if ($action == 'old_harbor') {
	...
	if ($user['char_life_cur'] > 0) {
		$user['description'] = 'Белый песок и чистая вода, ракушки и яркие морские звезды, которыми усеян берег этого побережья, - не оставят равнодушными любителей морских красот.';
	}else{
