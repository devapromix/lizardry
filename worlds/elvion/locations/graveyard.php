	...
	if ($user['char_life_cur'] > 0) {
		...
		switch ($user['char_region']) {
			...
			case 5:
				...
				break;
			case 6:
				$user['description'] = 'Старое кладбище у городских ворот. Ночь. Тихо. Спокойно. Ветер развевает стаи облаков. Одиноким глазом на Вас смотрит полная луна. Вы стоите в раздумии, что же делать дальше.';
				break;
			case 7:
