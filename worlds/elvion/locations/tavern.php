...
if ($action == 'tavern') {
	...
	$user['title'] = 'Таверна';
	$user['description'] = 'Вы входите в таверну. Здесь шумно и людно. Трактирщик то и дело, что успевает материть каждого на чем свет стоит и напоминать, что будет с ними, если кто-то что-то умыкнет. Ясное дело, его никто не слушает. Все столы заняты и любопытных глаз уйма. Можно даже сказать, что каждая пара глаз любопитна и каждого вновь вошедшего встречают хмурым негодованием.';
	$user['frame'] = 'tavern';	
	$user['links'] = array();
