...
if ($action == 'guild_main') {
	...
	$user['description'] = 'После занятий с Мастером в Тренировочном Зале Вы получаете новый уровень и очки развития навыков, которые можете потратить в других гильдиях на изучение новых навыков или улучшения уже известных. Сейчас у Вас '.$user['char_lp'].' оч.';
	$user['links'] = array();
