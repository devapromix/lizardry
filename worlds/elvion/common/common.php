...
function gen_enemy($enemy_ident) {
	...
	$user['enemy_life_max'] = round($enemy['enemy_level'] * 4.6) + rand(5, 20);
	$user['enemy_life_cur'] = $user['enemy_life_max'];
	$user['enemy_damage_min'] = round($enemy['enemy_level'] / 2.1) + 1;
	$user['enemy_damage_max'] = round($enemy['enemy_level'] / 2.1) + 3;
